...
import { getPageConfiguration, getPullPlan } from "./R1999-get-input.js";
...
import { chibiHtmlFragment, R1999TourSteps, helpContentMap } from './tutorial-config.js';

export class R1999PageController {
    constructor(parts) {
        this.parts = parts;
        this.persistence = createPersistence('reverse', SELECTORS);
