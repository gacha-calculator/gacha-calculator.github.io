export const chibiHtmlFragment = `
    <div class="chibi-group">
        ...
        <img src="/images/37_chibi.webp" alt="Tutorial Assistant" class="tutorial-chibi">
        </div>
        <button class="btn btn--tutorial_next">>></button>
        <button class="btn btn--tutorial_end">x</button>
    </div>`;

export const R1999TourSteps = [
    {
    ...
    },
    {
        ...
        text: '<p>First, input your current pity and guarantees here. You can import data from kornblume directly(press ? near respective elements to learn more)</p>',
        position: 'right'
    },
    {
        id: 'pull-plan-step',
    ...
    },
    {
        ...
        text: '<p>You\'ll get a chart showing the probability of success for each number of pulls until 100%.</p>',
        position: 'top'
    },
    {
