...
import { initializeTables, restorePityTable } from "./silver-palace-initialize-inputs.js";
...
import { DataValidator } from './silver-palace-data-validator.js';
...
import { getPageConfiguration, getPullPlan } from "./silver-palace-get-input.js";
...
export class SilverPalacePageController {
    constructor(parts) {
        this.parts = parts;
        this.persistence = createPersistence('silver-palace', SELECTORS);
    ...
    initialize() {
        ...
        initializeTables(this.persistence, this.parts.gachaConfig, this.validator, type, CONSTELLATION_OPTIONS);
        initializeTabs();
