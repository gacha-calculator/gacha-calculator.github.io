...
import { chibiHtmlFragment, GFL2TourSteps, helpContentMap } from './tutorial-config.js';

export class GFL2PageController {
    constructor(parts) {
        this.parts = parts;
        this.persistence = createPersistence('gfl2', SELECTORS);
