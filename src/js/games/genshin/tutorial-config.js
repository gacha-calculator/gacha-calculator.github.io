export const chibiHtmlFragment = `
...
export const genshinTourSteps = [
    ...
    },
    {
        ...
        text: '<p>First, input your current pity count, guarantee status, Capturing Radiance, and Epitomized Path points here. You can import this data directly from paimon.moe. (Press the <strong>?</strong> near respective element for more details.)</p>',
        position: 'right',
        size: 'big'
    },
    {
    ...
    },
    {
        ...
        text: '<p>You\'ll see a chart showing the probability of success for different numbers of pulls, all the way up to 100%. Use this to plan your strategy.</p>',
        position: 'top'
    },
    {
...
export const helpContentMap = {
    'pity-input-step': { tourStepId: 'pity-input-step' },
    'constellation-input-step': { tourStepId: 'constellation-input-step' },
    'pull-plan-step': { tourStepId: 'pull-plan-step' },
    'calculate-button-step': { tourStepId: 'calculate-button-step' },

    'import-help': {
        element: '.tab-panel-card',
        text: '<p>You can import your data directly from <a href="https://paimon.moe/" target="_blank" rel="noopener noreferrer" class="soft-link">paimon.moe</a>. Click the "Import Data" button and paste the exported JSON data. It will also calculate caprad, unless there are manual 5* inputs after it\'s introduction.</p>',
        position: 'right',
        size: 'big'
    },
    'export-help': {
