...
function cashbackSSR(probabilitiesSSR, standardPool, standardCons, cashbackRoadmap, gachaConfig) {
    ...
    for (const combo of offRateCharCombos) {
        ...
        const lost5050Config = { maxType: 7, regularPoints: gachaConfig.configSSR.regularStandardPoints, specialPoints: gachaConfig.configSSR.specialStandardPoints }
