...
import { chibiHtmlFragment, wuwaTourSteps, helpContentMap } from './tutorial-config.js';
...
export class WuwaPageController {
    constructor(parts) {
        this.parts = parts;
        this.persistence = createPersistence('wuwa', SELECTORS);
